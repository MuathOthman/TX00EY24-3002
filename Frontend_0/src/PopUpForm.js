      ...
      {modal && (
        <div className="modal">
          ...
          <div className="textfield">
              <Field label="Enter Address" topLabel="Address" type="text" />
              <Field label="Enter City" topLabel="City" type="text" />
              <Field label="Enter State/Region" topLabel="State / Region" type="text" />
            </div>
            <div className="textfield-two">
              <Field label="12345" topLabel="Zipcode" type="text" />
              <Field label="Enter total Investment" topLabel="Total Investment" type="currency" />
              <Field label="Enter Monthly revenue" topLabel="Monthly revenue" type="currency"/>
            </div>
            <AreaField
