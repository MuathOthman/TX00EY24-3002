...
function Signin() {
    ...
    const onSubmit = () => {
        ...
        fetch('http://localhost:8003/api/users/login', {
            method: 'POST',
            headers: {
    ...
    return (
        <div className="container">
            ...
            <div className="form-container">
                ...
                <div class="account">
                    <p>
                        Don't have an account? <a href="#" onclick="signIn()">Register</a>
                    </p>
                </div>
                <div className="form-fields">
                    <Field label="Email" icon="atSign" type="email" value={email} onChange={handleEmailChange}/>
                    <Field label="Password" icon="lock" type="password" value={password} onChange={handlePasswordChange}/>
                </div>
